...
namespace NetBpm.Test.Workflow.Organisation
{
	...
	public class OrganisationComponentTest
	{
		...
		protected internal IOrganisationSessionLocal orgComp = null;
		...
		public void SetUp()
		{
			...
			orgComp = servicelocator.GetService(typeof (IOrganisationSessionLocal)) as IOrganisationSessionLocal;
		}
