...
public class CutAction extends AbstractAction
{
    ...
    public static final String NAME_VALUE = "Cut";
    ...
    public static final int KEY_STROKE_CODE = KeyEvent.VK_X;
    ...
    public static final String SHORT_DESCRIPTION_VALUE = "Cut";
     ...
     */
    public CutAction(JEditTextArea testArea )
    {
        super( NAME_VALUE );
