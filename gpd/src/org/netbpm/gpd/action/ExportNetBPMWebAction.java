...
public class ExportNetBPMWebAction extends AbstractAction{
	...
	/** The long description text of this action */
	 public static final String LONG_DESCRIPTION_VALUE = 
		 "Export to NetBPM webinterface.xml";
	...
	public static final String SHORT_DESCRIPTION_VALUE = "Export to NetBPM webinterface.xml";

	private GpdGraph graph;
	
	public ExportNetBPMWebAction( GpdGraph graph )
	{
		super( NAME_VALUE );
        ...
        protected void export(File file, String graphName)
        {
                try {
                        GraphModelFileFormat graphModelFileFormat =
                                new NetBPMWebFileFormatXML(graphName);
