...
namespace NetBpm.Workflow.Organisation.Impl
{
	...
	{
		private static readonly NetBpm.Workflow.Organisation.Impl.OrganisationComponentImpl instance = new NetBpm.Workflow.Organisation.Impl.OrganisationComponentImpl();
		private static readonly ILog log = LogManager.GetLogger(typeof (NetBpm.Workflow.Organisation.Impl.OrganisationComponentImpl));

		/// <summary> gets the singleton instance.</summary>
		public static NetBpm.Workflow.Organisation.Impl.OrganisationComponentImpl Instance
		{
			get { return instance; }
