...
public	class AccessDialog extends JDialog
		...
		private Object[] accessOptions={"not-accessible","read-only","write-only","write-only-required","read-write","read-write-required"};
		...
		public AccessDialog() {
			...
			String msgString1 = "specifies the access to this field in the activity.";
