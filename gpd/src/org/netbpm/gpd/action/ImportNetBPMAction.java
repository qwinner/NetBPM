...
public class ImportNetBPMAction extends AbstractAction{
	/** The short descriptive name = "Print Preview  ..." */
	public static final String NAME_VALUE = "import processdefinition ...";
	...
	/** The long description text of this action */
	 public static final String LONG_DESCRIPTION_VALUE = 
		 "Import to NetBPM processdefinition.xml";

	/** Short description for tool-tip */
	public static final String SHORT_DESCRIPTION_VALUE = "Import to NetBPM processdefinition.xml";

	private GpdGraph graph;
	
	public ImportNetBPMAction( GpdGraph graph )
	{
		super( NAME_VALUE );
