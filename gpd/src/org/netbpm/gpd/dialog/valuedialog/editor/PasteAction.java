...
public class PasteAction extends AbstractAction
{
    ...
    public static final String NAME_VALUE = "Paste";
    
    /** The mnemonic keycode = KeyEvent.VK_P */
    public static final int MNEMONIC_CODE = KeyEvent.VK_V;

    /** The keystroke key-code = java.awt.event.KeyEevnt.VK_P */
    public static final int KEY_STROKE_CODE = KeyEvent.VK_V;
    ...
    public static final String SHORT_DESCRIPTION_VALUE = "Paste";
     ...
     */
    public PasteAction(JEditTextArea testArea )
    {
        super( NAME_VALUE );
