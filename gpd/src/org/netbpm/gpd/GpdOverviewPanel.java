...
public class GpdOverviewPanel
	 ...
	 */
	protected GpdOverviewPanel(GpdGraph g, ProcessDesigner d) {
		originalGraph = g;
	...
	public static JPanel createOverviewPanel(GpdGraph g, ProcessDesigner d){
		...
		panelWithInternalOffset.add(new GpdOverviewPanel(g,d), BorderLayout.CENTER);
