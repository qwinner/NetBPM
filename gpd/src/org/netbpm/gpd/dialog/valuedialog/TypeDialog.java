...
public	class TypeDialog extends JDialog
		...
		private Object[] accessOptions={"actor","text","long","integer","float","date","evaluation"};
		...
		public TypeDialog() {
			...
			setTitle("predefined data types");
			setSize(350,150);
			setModal(true);
			accessComboBox = new JComboBox(accessOptions);

			//Create an array of the text and components to be displayed.
			String msgString1 = "specifies the type to this attribute in the activity.";
