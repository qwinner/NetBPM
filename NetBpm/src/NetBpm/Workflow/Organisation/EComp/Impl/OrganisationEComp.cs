...
{
	[Transactional]
	public class OrganisationEComp : AbstractEComp, IOrganisationSessionLocal
	{
		private static readonly ILog log = LogManager.GetLogger(typeof (OrganisationEComp));
		private static readonly OrganisationComponentImpl implementation = OrganisationComponentImpl.Instance;

		public OrganisationEComp(ISessionManager sessionManager) : base(sessionManager)
		{
		}
